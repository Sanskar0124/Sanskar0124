...
With nearly **5 years of hands-on experience**, I specialize in building secure, scalable, and production-grade web applications. I’ve worked across **B2B marketplaces, CRM platforms, and SaaS products** — from architecture to deployment.

- 🚀 Currently leading development at **PIPEX.AI** as a Full Stack Developer & Team Lead
- 🧠 Founder of **Trimvault**, a salon management system in active use
- 🛠️ Skilled in **React JS, Node.js, Django, MongoDB, Docker, AWS, Jenkins, and NGINX**
- ⚙️ Implemented CI/CD pipelines, scalable DevOps solutions, and role-based dashboards
...
**Languages:** JavaScript, TypeScript, Python, SQL, Java, Bash  
**Frontend:** React JS, Next.js, Bootstrap, Material UI  
**Backend:** Node.js, Express.js, Django, REST APIs  
**Database:** MongoDB, SQLite, MySQL  
**DevOps:** Docker, Jenkins, NGINX, PM2, AWS (EC2, S3), CI/CD  
**Tools:** Git, Postman, Figma, Firebase, Bitbucket, Jira
...
- 💼 LinkedIn: [https://www.linkedin.com/in/sanskar-sakhareliya-1a64451a0/](https://www.linkedin.com/in/sanskar-sakhareliya-1a64451a0/)
- 🌐 Portfolio: [https://sanskar0124.github.io/My-Portfolio](https://sanskar0124.github.io/My-Portfolio)
